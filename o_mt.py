class Mt_Out:
    ...
    def get_help(self):
        ...
        help_cmd += "!'draw' int1, int2, int3, int4, int5  \n"
        help_cmd += "!'translate' lang1 lang2 txt (example: !translate fr en Non! Merci) \n"
        help_cmd += "!'langhelp' : get all lang available ex: lang1 lang2 lang3 ... \n"
        help_cmd += "!'convert' currency1 amount currency2 : currency1 to currency2 \n"
        help_cmd += "!'vo2a/va2o/oa2v': Ohm's law with ohm(o) amp(a) volt(v) \n"
        ...
        help_cmd +=  "!'help' credit to Zipdigital(host) and Soizik(dev)"
    ...
    def get_lang(self):
        lang_cmd = []
        lang_cmd += '```' 
        lang_cmd += "'ht', 'af', 'sq', 'de', 'en', 'ar', 'az', 'eu', 'be', 'bn', 'bg', 'bs' \n"
        lang_cmd += "'zh', 'da', 'iw', 'id', 'hi', 'eo', 'et', 'fi', 'tl', 'fr', 'gl', 'gu' \n"
        lang_cmd += "'el', 'ga', 'is', 'it', 'ja', 'jw', 'ka', 'kn', 'ca', 'km', 'hr', 'uk' \n"
        lang_cmd += "'ur', 'tr', 'la', 'lo', 'lv', 'lt', 'ms', 'mt', 'mr', 'mk', 'no', 'nl' \n"
        lang_cmd += "'hu', 'es', 'fa', 'pl', 'pt', 'ru', 'sr', 'sk', 'sl', 'sw', 'sv', 'ta' \n"
        lang_cmd += "'th', 'te', 'cs', 'vi', 'cy', 'ro', 'yi', 'ko' \n"
        lang_cmd += '```'
        return ''.join(lang_cmd)
